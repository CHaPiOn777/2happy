    ...
    <Section className="my-12 sm:my-section">
      <Container className="flex-col gap-8 sm:gap-12 lg:gap-16">
        ...
        >
          ...
          />
          <div className="w-full flex flex-col justify-between sm:h-[272px] bg-main pt-6 pb-6 sm:pt-10 sm:pb-6 px-4 text-white text-center sm:col-start-3 md:col-start-2 lg:col-start-auto row-start-3 md:row-start-1 md:row-span-2 lg:row-span-4 ">
