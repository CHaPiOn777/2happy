...
const ContactUsSection = () => {
  return (
    <Section className="my-section">
      <Container>
        <div className="hidden sm:block w-[200px] sm:w-[280px] md:w-[356px] lg:w-[416px] h-[264px] sm:h-[340px] md:h-[440px] lg:h-[504px] absolute bottom-[140px] xs:bottom-[290px] md:bottom-[184px] lg:bottom-[96px] right-4 md:right-6">
          <ImageWithLoader
            wrapperClassName=""
