...
const NewMain = () => {
  return (
    <Section className="border-b border-main bg-partnership-banner h-[536px] sm:h-[480px] lg:h-[760px] xl:h-[865px]">
      <div className="w-full  absolute block xl:hidden h-[440px] sm:h-full">
        <Image
          fill
          className="object-cover object-[50%_38%] -z-10"
      ...
      <Container className="gap-6 sm:items-center h-full mb-12 sm:mb-0">
        <div className="flex flex-col gap-8 justify-between sm:justify-normal lg:-mt-6 z-20">
          <h1 className="text-h1 sm:text-h2 md:text-h1 uppercase mt-[104px] sm:mt-0">
        ...
        <div className="absolute bottom-0 left-0 w-full h-[128px] block sm:hidden bg-[linear-gradient(to_top,_white_75%,_transparent)] z-10" />
      </Container>
    </Section>
  );
};
